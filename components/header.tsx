      ...
      <div className="w-full px-3 sm:px-4">
        <div
          className={`flex items-center justify-between transition-all duration-500 min-h-0 w-full overflow-visible ${
            isScrolled ? "h-12 sm:h-14 py-2" : "h-14 sm:h-16 lg:h-20"
          }`}
        >
          {/* Logo SIKOMJARU di kiri */}
          <Link
            href="/"
            className="flex items-center space-x-2 sm:space-x-3 z-10 flex-shrink-0"
          >
            <div
          ...
          >
            <Link
              href="/"
              className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-gray-900 hover:text-teal-600 transition-colors whitespace-nowrap"
            >
              SIKOMJARU
            </Link>
          </div>
          ...
          <div className="absolute top-full left-0 w-full bg-white shadow-xl border-b border-gray-200 z-40">
            <div className="px-4 py-4 sm:py-6">
              <nav className="flex flex-col space-y-2 sm:space-y-4">
                <a
                  href="#home"
                  className="text-gray-700 hover:text-teal-600 font-medium py-2 px-3 sm:px-4 rounded-lg hover:bg-gray-50 transition-colors text-sm sm:text-base"
